# Flask stack for Wodby

Deploy Flask on Kubernetes with Wodby. This repository contains the stack
manifests used by the public Flask stack in the Wodby catalog.
